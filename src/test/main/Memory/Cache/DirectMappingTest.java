...
public class DirectMappingTest {
    ...
    public void test03() {
        ...
        assertArrayEquals(data, cache.read(pAddr, data.length));
        // 判断Cache状态是否符合预期
        assertTrue(cache.checkStatus(new int[]{Integer.parseInt(t.BinaryToDecimal("0000000001"))}, new boolean[]{true}, new char[][]{"0000000000000000000000".toCharArray()}));
        cache.clear();
    }
    ...
    public void test04() {
        ...
        assertArrayEquals(data, cache.read(pAddr, data.length));
        // 判断Cache状态是否符合预期
        assertTrue(cache.checkStatus(new int[]{Integer.parseInt(t.BinaryToDecimal("0000000001"))}, new boolean[]{true}, new char[][]{"0000000000010000000000".toCharArray()}));
        cache.clear();
    }
}
